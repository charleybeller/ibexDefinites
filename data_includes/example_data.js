...
*/
    ...
    [["ER1", "IE"], "AcceptabilityJudgment", {s: "The waiter that <span class=dp>the bastard</span> reprimanded avoided <span class=dp>him</span>."}],
    [["ER2", "IE"], "AcceptabilityJudgment", {s: "<span class=dp>The bastard</span> avoided the waiter that <span class=dp>he</span> reprimanded."}],
    [["ER3", "IE"], "AcceptabilityJudgment", {s: "The waiter that <span class=dp>he</span> reprimanded avoided <span class=dp>the bastard</span>."}],
    [["ER4", "IE"], "AcceptabilityJudgment", {s: "<span class=dp>He</span> avoided the waiter that <span class=dp>the bastard</span> reprimanded."}}]  
    [["ER5", "IE"], "AcceptabilityJudgment", {s: "The waiter that <span class=dp>the bastard</span> reprimanded avoided <span class=dp>the bastard</span>."}],
    [["ER6", "IE"], "AcceptabilityJudgment", {s: "<span class=dp>The bastard</span> avoided the waiter that <span class=dp>the bastard</span> reprimanded."}],

    [["EG1", "JE"], "AcceptabilityJudgment", {s: "<span class=dp>The jerk's</span> roommates met <span class=dp>him</span> at the restaurant."}],
    [["EG2", "JE"], "AcceptabilityJudgment", {s: "<span class=dp>The jerk</span> met <span class=dp>his</span> roomates at the restaurant."}],
    ...
    [["EG1", "PE"], "AcceptabilityJudgment", {s: "<span class=dp>The creep's</span> daughter refused to see <span class=dp>him</span>."}],
    [["EG2", "PE"], "AcceptabilityJudgment", {s: "<span class=dp>The creep</span> refused to see <span class=dp>his</span> daughter."}],
    [["EG3", "PE"], "AcceptabilityJudgment", {s: "<span class=dp>His</span> daughter refused to see <span class=dp>the creep</span>."}],
    [["EG4", "PE"], "AcceptabilityJudgment", {s: "<span class=dp>He</span> refused to see <span class=dp>the creep's</span> daughter."}],
    [["EG5", "PE"], "AcceptabilityJudgment", {s: "<span class=dp>The creep's</span> daughter refused to see <span class=dp>the creep</span>."}],
    [["EG6", "PE"], "AcceptabilityJudgment", {s: "<span class=dp>The creep</span> refused to see <span class=dp>the creep's</span> daughter."}],

    [["ER1", "QE"], "AcceptabilityJudgment", {s: "The spy that <span class=dp>the fool</span> confronted hit <span class=dp>him</span> in the ribs."}],
    [["ER2", "QE"], "AcceptabilityJudgment", {s: "<span class=dp>The fool</span> hit the spy that <span class=dp>he</span> confronted in the ribs."}],
    [["ER3", "QE"], "AcceptabilityJudgment", {s: "The spy that <span class=dp>he</span> confronted hit <span class=dp>the fool</span> in the ribs."}],
    [["ER4", "QE"], "AcceptabilityJudgment", {s: "<span class=dp>He</span> hit the spy that <span class=dp>the fool</span> confronted in the ribs."}],
    [["ER5", "QE"], "AcceptabilityJudgment", {s: "The spy that <span class=dp>the fool</span> confronted hit <span class=dp>the fool</span> in the ribs."}],
    [["ER6", "QE"], "AcceptabilityJudgment", {s: "<span class=dp>The fool</span> hit the spy that <span class=dp>the fool</span> confronted in the ribs."}],

    [["ER1", "RE"], "AcceptabilityJudgment", {s: "The friend that <span class=dp>the punk</span> bought cigarettes from went to the show with <span class=dp>her</span>."}],
    [["ER2", "RE"], "AcceptabilityJudgment", {s: "<span class=dp>The punk</span> went to the show with the friend that <span class=dp>she</span> bought cigarettes from."}],
    [["ER3", "RE"], "AcceptabilityJudgment", {s: "The friend that <span class=dp>she</span> bought cigarettes from went to the show with <span class=dp>the punk</span>."}],
    [["ER4", "RE"], "AcceptabilityJudgment", {s: "<span class=dp>She</span> went to the show with the friend that <span class=dp>the punk</span> bought cigarettes from."}],
    [["ER5", "RE"], "AcceptabilityJudgment", {s: "The friend that <span class=dp>the punk</span> bought cigarettes from went to the show with <span class=dp>the punk</span>."}],
    [["ER6", "RE"], "AcceptabilityJudgment", {s: "<span class=dp>The punk</span> went to the show with the friend that <span class=dp>the punk</span> bought cigarettes from."}],

    [["ER1", "SE"], "AcceptabilityJudgment", {s: "The person that <span class=dp>the fool</span> invited sat with <span class=dp>her</span> at the concert."}],
    [["ER2", "SE"], "AcceptabilityJudgment", {s: "<span class=dp>The fool</span> sat with the person that <span class=dp>she</span> invited at the concert."}],
    [["ER3", "SE"], "AcceptabilityJudgment", {s: "The person that <span class=dp>she</span> invited sat with <span class=dp>the fool</span> at the concert."}],
    [["ER4", "SE"], "AcceptabilityJudgment", {s: "<span class=dp>She</span> sat with the person that <span class=dp>the fool</span> invited at the concert."}],
    [["ER5", "SE"], "AcceptabilityJudgment", {s: "The person that <span class=dp>the fool</span> invited sat with <span class=dp>the fool</span> at the concert."}],
    [["ER6", "SE"], "AcceptabilityJudgment", {s: "<span class=dp>The fool</span> sat with the person that <span class=dp>the fool</span> invited at the concert."}],

    [["EG1", "TE"], "AcceptabilityJudgment", {s: "<span class=dp>The schmuck's</span> son left <span class=dp>him</span> in the rain."}],
    [["EG2", "TE"], "AcceptabilityJudgment", {s: "<span class=dp>The schmuck</span> left <span class=dp>his</span> son in the rain."}],
    [["EG3", "TE"], "AcceptabilityJudgment", {s: "<span class=dp>His</span> son left <span class=dp>the schmuck</span> in the rain."}],
    [["EG4", "TE"], "AcceptabilityJudgment", {s: "<span class=dp>He</span> left <span class=dp>the schmuck's</span> son in the rain."}],
    [["EG5", "TE"], "AcceptabilityJudgment", {s: "<span class=dp>The schmuck's</span> son left <span class=dp>the schmuck</span> in the rain."}],
    [["EG6", "TE"], "AcceptabilityJudgment", {s: "<span class=dp>The schmuck</span> left <span class=dp>the schmuck's</span> son in the rain."}],

    [["ER1", "VE"], "AcceptabilityJudgment", {s: "The cousin that <span class=dp>the brat</span> wrote about talked with <span class=dp>him</span> at the picnic."}],
    [["ER2", "VE"], "AcceptabilityJudgment", {s: "<span class=dp>The brat</span> talked with the cousin that <span class=dp>he</span> wrote about at the picnic."}],
    [["ER3", "VE"], "AcceptabilityJudgment", {s: "The cousin that <span class=dp>he</span> wrote about talked with <span class=dp>the brat</span> at the picnic."}],
    [["ER4", "VE"], "AcceptabilityJudgment", {s: "<span class=dp>He</span> talked with the cousin that <span class=dp>the brat</span> wrote about at the picnic."}],
    [["ER5", "VE"], "AcceptabilityJudgment", {s: "The cousin that <span class=dp>the brat</span> wrote about talked with <span class=dp>the brat</span> at the picnic."}],
    [["ER6", "VE"], "AcceptabilityJudgment", {s: "<span class=dp>The brat</span> talked with the cousin that <span class=dp>the brat</span> wrote about at the picnic."}],

    [["ER1", "WE"], "AcceptabilityJudgment", {s: "The girl that <span class=dp>the creep</span> liked avoided <span class=dp>him</span> at the party."}],
    [["ER2", "WE"], "AcceptabilityJudgment", {s: "<span class=dp>The creep</span> avoided the girl that <span class=dp>he</span> liked at the party."}],
    [["ER3", "WE"], "AcceptabilityJudgment", {s: "The girl that <span class=dp>he</span> liked avoided <span class=dp>the creep</span> at the party."}],
    [["ER4", "WE"], "AcceptabilityJudgment", {s: "<span class=dp>He</span> avoided the girl that <span class=dp>the creep</span> liked at the party."}],
    [["ER5", "WE"], "AcceptabilityJudgment", {s: "The girl that <span class=dp>the creep</span> liked avoided <span class=dp>the creep</span> at the party."}],
    [["ER6", "WE"], "AcceptabilityJudgment", {s: "<span class=dp>The creep</span> avoided the girl that <span class=dp>the creep</span> liked at the party."}],

    [["ER1", "XE"], "AcceptabilityJudgment", {s: "The driver that <span class=dp>the jackass</span> passed honked at <span class=dp>him</span> on the highway."}],
    [["ER2", "XE"], "AcceptabilityJudgment", {s: "<span class=dp>The jackass</span> honked at the driver that <span class=dp>he</span> passed on the highway."}],
    [["ER3", "XE"], "AcceptabilityJudgment", {s: "The driver that <span class=dp>he</span> passed honked at <span class=dp>the jackass</span> on the highway."}],
    [["ER4", "XE"], "AcceptabilityJudgment", {s: "<span class=dp>He</span> honked at the driver that <span class=dp>the jackass</span> passed on the highway."}],
    [["ER5", "XE"], "AcceptabilityJudgment", {s: "The driver that <span class=dp>the jackass</span> passed honked at <span class=dp>the jackass</span> on the highway."}],
    [["ER6", "XE"], "AcceptabilityJudgment", {s: "<span class=dp>The jackass</span> honked at the driver that <span class=dp>the jackass</span> passed on the highway."}],

    [["ER1", "ZE"], "AcceptabilityJudgment", {s: "The person that <span class=dp>the asshole</span> ran into shouted at <span class=dp>him</span>."}],
    [["ER2", "ZE"], "AcceptabilityJudgment", {s: "<span class=dp>The asshole</span> shouted at the person that <span class=dp>he</span> ran into."}],
    [["ER3", "ZE"], "AcceptabilityJudgment", {s: "The person that <span class=dp>he</span> ran into shouted at <span class=dp>the asshole</span>."}],
    [["ER4", "ZE"], "AcceptabilityJudgment", {s: "<span class=dp>He</span> shouted at the person that <span class=dp>the asshole</span> ran into."}],
    [["ER5", "ZE"], "AcceptabilityJudgment", {s: "The person that <span class=dp>the asshole</span> ran into shouted at <span class=dp>the asshole</span>."}],
    [["ER6", "ZE"], "AcceptabilityJudgment", {s: "<span class=dp>The asshole</span> shouted at the person that <span class=dp>the asshole</span> ran into."}]
*/
];
